...
public class ChessMatch {
	...
	private Board board;
	private boolean check, checkMate; //  nao pode ser wrapper class por que o valor nulo é retornado, gerando o nullPointer.
	...
	private Piece makeMove(Position source, Position target) {
		...
		if(p instanceof Pawn) {
			if(source.getColumn() != target.getColumn() && capturedPiece == null) {
				...
				pawnPosition = (p.getColor() == Color.WHITE) ? new Position(target.getRow() + 1, target.getColumn()) 
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		if(p instanceof Pawn) {
			if(source.getColumn() != target.getColumn() && capturedPiece == enPassantVulnerable) {
				...
				Position pawnPosition;
				pawnPosition = (p.getColor() == Color.WHITE) ? new Position(3, target.getColumn()) 
	...
	private void validateSourcePosition(Position position) {
		...
		// a posição selecionada não tem peça.
